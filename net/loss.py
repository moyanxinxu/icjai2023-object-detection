...
from net.utils.match import match
from net.utils.sample import hard_negative_mining


class SSDLoss(nn.Module):
    """ 损失函数 """

    def __init__(self, n_classes, variance=(0.1, 0.2), overlap_thresh=0.5, neg_pos_ratio=3,
                 **kwargs):
        """
        Parameters
        ----------
